...
[SelectionBase]
public class SO_POI : EntityMonoBehaviour
{
    ...
    public override void Init ()
    {
        ...
        mgr.AddComponentData(entity, new SignalAbilityAssignment { Ability = (byte)UtilityAI.AbilityTags.Defend });
        mgr.AddComponentData(entity, new SignalDeleteOnCancel());
